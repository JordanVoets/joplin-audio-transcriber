...
import { RequestConfig, HttpMethod, Response, HttpError } from '../../src/http/types';
...
describe('loggingMiddleware', () => {
  ...
  it('should log query parameters if present', () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith('[HTTP] Query:', { q: 'test', limit: 10 });
  });
...
describe('transformResponseInterceptor', () => {
  it('should transform response data', () => {
    ...
    const result = interceptor(response) as unknown as Response<{ doubled: number }>;
  ...
  it('should handle complex transformations', () => {
    ...
    const interceptor = transformResponseInterceptor<Input, Output>(transformer);
